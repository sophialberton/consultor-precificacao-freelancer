...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const formulario = document.getElementById('calculator-form'); // Formulário de cálculo
    const containerResultado = document.getElementById('result-container'); // Div que mostra o resultado
    const valorResultado = document.getElementById('result-value'); // Elemento que exibe o valor calculado
    ...
    formulario.addEventListener('submit', function(e) {
        ...
        const valorProjeto = parseFloat(document.getElementById('project-value').value); // Valor total do projeto
        const horasDiarias = parseFloat(document.getElementById('daily-hours').value); // Horas trabalhadas por dia
        const diasTrabalhados = parseFloat(document.getElementById('work-days').value); // Dias trabalhados por semana
        const diasFerias = parseFloat(document.getElementById('vacation-days').value); // Dias de férias
